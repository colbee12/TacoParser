        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                var corA = new GeoCoordinate(
                    locA.Location.Latitude, locA.Location.Longitude);
            ...
            // TODO: Once you have locB, create a new Coordinate object called `corB` with your locB's latitude and longitude.
                    ...
                    var corB = new GeoCoordinate(
                        locB.Location.Latitude, locB.Location.Longitude);
            ...
            Console.WriteLine("Two farthest Taco Bells:");
            Console.WriteLine($"{tacoBellA.Name}");
            Console.WriteLine($"{tacoBellB.Name}");
            Console.WriteLine($"Distance (meters): {maxDistance}");
